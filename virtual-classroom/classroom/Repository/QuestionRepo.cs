    ...
    public class QuestionRepo : IQuestionRepo
    {
        ...
        public List<Question> GetQuestionById(int id)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    string selectQuery = "SELECT * FROM Question WHERE id = @Id";
                    using (SqlCommand command = new SqlCommand(selectQuery, connection))
                    {
                        ...
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ...
                                question.question = reader.GetString(reader.GetOrdinal("question"));
                                question.Opt1 = reader.GetString(reader.GetOrdinal("Opt1"));
                                question.Opt2 = reader.GetString(reader.GetOrdinal("Opt2"));
                                question.Opt3 = reader.GetString(reader.GetOrdinal("Opt3"));
                                question.Opt4 = reader.GetString(reader.GetOrdinal("Opt4"));
                                question.answer = reader.GetString(reader.GetOrdinal("answer"));
